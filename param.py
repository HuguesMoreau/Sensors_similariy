...
data_path = Path(r"[data_path_directory]")  # Path to the SHL data
...
duration_window = 5     # parameters for spectrogram creation, in seconds
...
spectro_batch_size = 1000  # parameter for spectrogram computation.
  ...
  # you may adapt this depending on your RAM capacity
